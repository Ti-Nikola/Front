...
export const docNatural2 = async (projectStage: any) => {
        ...
        children: [
          new Paragraph({
            ...
            children: [
              ...
              new TextRun({
                text: `En Santiago de Chile, a ${formattedDate}, entre ENEL DISTRIBUCIÓN CHILE S.A., RUT N° 96.800.570-7, representada por don Maximiliano Domínguez Rivera, cédula nacional de identidad N° 9.216.950-2, ambos domiciliados en Avenida Santa Rosa N° 76, Piso 8, de la comuna y ciudad de Santiago, en adelante también e indistintamente la Empresa Distribuidora, por una parte, y, por la otra, ${projectStage.client_name}, RUT N° ${projectStage.client.rut} y ${projectStage.additional_client_name}, RUT N° ${projectStage.additional_client_rut}, en adelante también e indistintamente el Usuario o Cliente Final,
                 domiciliado en ${projectStage.direccion}, de la comuna de ${projectStage.comuna}, de la ciudad de Santiago, se ha convenido en el siguiente contrato de conexión:`,
                break: 3,
                size: 24,
                font: 'Arial MT',
              }),
